...
- ### 哈希表（Hash table）
    ...
    - [ ] 在线课程：
        ...
        - [x] [电话薄问题（Phone Book Problem）（视频）](https://www.coursera.org/learn/data-structures/lecture/NYZZP/phone-book-problem)
        - [ ] 分布式哈希表：
...
- ### 系统设计、可伸缩性、数据处理
    ...
    - [x] [数据库范式 - 1NF, 2NF, 3NF and 4NF (video)](https://www.youtube.com/watch?v=UrYLYV7WSHM)
